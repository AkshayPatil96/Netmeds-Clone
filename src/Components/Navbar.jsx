          ...
          <li className="perentList">
            ...
            <div className="sub_list">
              <ul>
                ...
                <li>
                  <Link className="subLink" to={"/beauty/hair"}>
                    Hair
                  </Link>
                </li>

                <li>
                  <Link className="subLink" to={"/beauty/skinCare"}>
                    Skin Care
                  </Link>
                </li>
                <li>
                  <Link className="subLink" to={"/beauty/momAndBaby"}>
                    Mom & Baby
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link className="subLink" to={"/beauty/makeUp"}>
                    Make-Up
                  </Link>
                </li>

                <li>
                  <Link className="subLink" to={"/beauty/fragrance"}>
                    Fragrances
                  </Link>
                </li>
                <li>
                  <Link className="subLink" to={"/beauty/men_sGrooming"}>
                    Men's Grooming
                  </Link>
                </li>
              </ul>
