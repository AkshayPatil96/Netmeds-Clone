...
const getCategory = (category) => async (dispatch) => {
  ...
  try {
    let response = await axios.get(
      `https://netmeds-backend.onrender.com/categories/${category}`
    );
...
const getProducts = (category, product) => async (dispatch) => {
  ...
  try {
    let response = await axios.get(
      `https://netmeds-backend.onrender.com/data?category=${category}&type=${product}`
    );
    let data = await response.data;
...
const getHomeData = () => async (dispatch) => {
  ...
  try {
    let response = await axios.get(
      `https://netmeds-backend.onrender.com/homepage`
    );
    let data = await response.data;
...
const getFilteredProducts = (category, product, brand) => async (dispatch) => {
  ...
  try {
    let response = await axios.get(
      `https://netmeds-backend.onrender.com/data?category=${category}&type=${product}&brand=${brand}`
    );
    let data = await response.data;
    dispatch(successProduct(data));
  } catch (error) {
...
const getFilteredManufacturers =
  (category, product, brand) => async (dispatch) => {
    ...
    try {
      let response = await axios.get(
        `https://netmeds-backend.onrender.com/data?category=${category}&type=${product}&seller=${brand}`
      );
      let data = await response.data;
      dispatch(successProduct(data));
    } catch (error) {
